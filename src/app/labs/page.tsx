    ...
    <div className="min-h-screen bg-black text-white p-4 md:p-20 flex flex-col items-center overflow-x-hidden">
      ...
      <header className="pt-12 pb-16 w-full max-w-7xl flex items-center justify-between">
        ...
        <div className="text-center flex flex-col items-center">
          ...
          <h1 className="hero-title text-3xl md:text-7xl leading-none">UTTF_LABS</h1>
          <p className="text-zinc-600 font-mono text-[8px] uppercase tracking-[0.3em] mt-2">Experimental_Zone</p>
        </div>
        <span className="text-zinc-900 font-mono text-lg">/03</span>
      </header>

      <main className="w-full max-w-7xl flex flex-col gap-12 md:gap-20">
        ...
        <section className="glass-panel p-1 border-orange-600/20 bg-orange-600/5">
          <div className="bg-black/40 rounded-[2.4rem] p-8 md:p-16 flex flex-col items-center text-center">
            ...
            <h2 className="text-2xl md:text-6xl font-black uppercase italic mb-6 tracking-tighter leading-none" style={{ fontFamily: 'var(--font-display)' }}>
            ...
            <button className="btn-urban scale-90">START_MONITORING</button>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-4 pb-32">
          <div className="glass-panel p-8 border-white/5">
            ...
            <h4 className="text-xl font-black italic uppercase mb-4" style={{ fontFamily: 'var(--font-display)' }}>LYRIC_ENGINE</h4>
            <div className="w-full h-1 bg-zinc-900 rounded-full overflow-hidden">
              <motion.div initial={{ width: 0 }} animate={{ width: '65%' }} className="h-full bg-orange-600" />
            </div>
          </div>
          ...
          <div className="glass-panel p-8 border-white/5 opacity-50">
            ...
            <h4 className="text-xl font-black italic uppercase mb-4" style={{ fontFamily: 'var(--font-display)' }}>BEAT_RENDER</h4>

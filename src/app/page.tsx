              ...
              publications.map((post) => {
                ...
                return (
                  <motion.div 
                    ...
                    viewport={{ once: true }}
                    key={post.id} 
                    className="glass-panel group overflow-hidden flex flex-col border border-white/5 bg-white/5 rounded-3xl hover:border-[#FF914D]/30 transition-all duration-500"
                  >
                    ...
                    <div className="p-8">
                      <h4 className="text-xl font-black uppercase italic mb-3 text-white tracking-tighter">
                        {post.title}
                      </h4>
